...
public class Schedule {
    ...
    private LocalDateTime Stringstart_time ; //Thời gian bắt đầu của buổi học
    private LocalDateTime end_time; //Thời gian kết thúc của buổi học
    private  String room_id ; //ID của phòng học được sử dụng cho buổi học

    public Schedule() {
    }

    public Schedule(String chedule_id, String stringclass_id, LocalDateTime stringstart_time, LocalDateTime end_time, String room_id) {
    ...
    public LocalDateTime getStringstart_time() {
        return Stringstart_time;
    }

    public void setStringstart_time(LocalDateTime stringstart_time) {
        Stringstart_time = stringstart_time;
    }
